...
plates_path = "C:\\Users\\user\\Desktop\\Project\\Egyption-license-plate-segmentor\\src\\100plates\\"


def segment_fn(img, show_characters, draw_fig):
    img_resized = resize_padding_fn(img, show=0)
    roi = detect_edges(img_resized, show=0)
    csv_values = draw_hist(roi, invert=1, show=1)
    promn = 8
    if draw_fig == 1:
...
img = cv2.imread(plates_path + "1.jpg")
