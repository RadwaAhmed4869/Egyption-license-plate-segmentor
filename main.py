...
plates_path = "C:\\Users\\user\\Desktop\\Project\\Egyption-license-plate-segmentor\\src\\107plates\\"
...
process_multi_img(0)
img = cv2.imread(plates_path + "167.jpg")
characters = segment_fn(img, show_characters=0, draw_fig=1)
